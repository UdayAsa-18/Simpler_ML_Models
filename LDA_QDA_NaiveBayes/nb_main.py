...
def rgb_qda():
    ...
    qda_rgb = GaussianNBModel() #creating instance for the GNBModel Class
...
def gray_qda():
    ...
    qda_gray = GaussianNBModel() #creating an instance for GNBModel class
